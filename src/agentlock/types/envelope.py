...
from agentlock.types.trace import ModelCall, ToolCall, TraceInput, TraceOutput
...
class TraceEnvelope(BaseModel):
    ...
    Matches `agentlock-spec` `trace-event.schema.json` (v0.1).
    ...
    Example:
        ...
        ... )
        >>> env.schema_version
        'agentlock-trace/v0.1'
    """

    model_config = ConfigDict(extra="allow")

    schema_version: str = "agentlock-trace/v0.1"
    trace_id: str
    run_id: str
    agent_id: str
